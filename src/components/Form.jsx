    ...
    return (
        <div  >
            ...
            <form onSubmit={handleSubmit} styles={{ display : 'flex',flexDirection : 'column' , justifyContent : 'center'  }}>
                        ...
                        <input  className='mt-3 btn rounded shadow' type="submit" style={{ height : '40px', wordWrap : 'true' ,fontSize : '24px',lineHeight:'40px' , border : 'solid 1px white', background : 'white', cursor : 'pointer' }}/>
                        </div>
                </form>
        </div>
    );
